# Generated by Django 5.0.6 on 2025-07-01 07:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(blank=True, null=True)),
                ('agency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='apis.agency')),
            ],
            options={
                'verbose_name': 'Branch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField()),
                ('rank', models.IntegerField()),
                ('project', models.ForeignKey(db_column='project', on_delete=django.db.models.deletion.CASCADE, related_name='form_sections', to='apis.project')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='project',
            name='project_head',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects', to='apis.projecthead'),
        ),
        migrations.CreateModel(
            name='AdminAuthToken',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('form_section_id', models.IntegerField(blank=True, null=True)),
