...
class Project(models.Model):
    ...
    project_head = models.ForeignKey('ProjectHead', null=True, blank=True, on_delete=models.SET_NULL, related_name='projects')
...
class FormSection(models.Model):
    """Form Section table"""
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name='form_sections', db_column='project')
